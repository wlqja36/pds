...
if (!JsNamespace.exist("Iject"))
{
	...
	JsNamespace.declare("Iject", {
		...
		appOnload : function(o)
		{
			...
			Iject.$["vFrameSet1"]     = o.mainframe.VFrameSet.VFrameSet1;			           			//VFrameSet1
			Iject.$["topFrame"]       = o.mainframe.VFrameSet.VFrameSet1.TopFrame;  					//TopFrame
			Iject.$["hFrame"]         = o.mainframe.VFrameSet.VFrameSet1.HFrameSet;                     //HFrame
			Iject.$["leftFrame"]      = o.mainframe.VFrameSet.VFrameSet1.HFrameSet.LeftFrame;           //leftFrame
			Iject.$["workFrame"]      = o.mainframe.VFrameSet.VFrameSet1.HFrameSet.WorkFrame;            //WorkForm
			Iject.$["mainFrame"]      = o.mainframe.VFrameSet.VFrameSet1.HFrameSet.WorkFrame.MainForm;  //mainform
		...
		setSeprateFrame : function()
		{
			...
			//**** 임시 필요에따라 삭제해서 사용
			Iject.$["userid"] = application.gds_User.getColumn(0,"id");
			Iject.$["usernm"] = application.gds_User.getColumn(0,"name");
