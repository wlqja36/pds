(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("POP_RAISREQ_MEN_HONA.xfdl", "Lib::common.xjs");
        this.registerScript("POP_RAISREQ_MEN_HONA.xfdl", function() {
        ...
        this.loadIncludeScript("POP_RAISREQ_MEN_HONA.xfdl");
