...
if (!JsNamespace.exist("Iject.Mdi")) {
    ...
    JsNamespace.declare("Iject.Mdi", {
        ...
        {
			//application.alert("공통 Mdi.js로 메뉴오픈콜 넘어옴");
            var pThis = Iject.Mdi.$;
			...
			//JKIM_2020.02.05_BEGIN : close a previous window
            ...
            var mLevel = ds.lookup("MENU_ID", sMenuId, "MENU_LEVEL");

            if (mLevel > 1) { 
				Iject.$["mdiFrame"].form.closePreWin(); 
				var oBtn = Iject.$["topFrame"].form.btn_leftMenuOpen;
				Iject.Mdi.leftMenuAction(this, oBtn);
            }
            //JKIM_2020.02.05_END : close a previous window
         ...
         * @memberOf Iject.Mdi
         * 
         * kjh, 2021.10.21 left menu 사용 안함
         */
         /*
		...
		*/
        ...
        newMdi : function(sMenuid,  nRow, aArgs)
        {
            ...
            var objNewWin = new ChildFrame;
                ...
                //Iject.$["mdiFrame"].form.fn_addTab(winid, strTitle);  JKIM_2020.01.31 : 열린창 탭 //mdi tab button add  
